...
TH.data = {
  ...
  /* Universe scanned by the 52-Week High Scanner page. Yahoo Finance symbols (".NS" = NSE)
     so live price history can be pulled directly — real symbols, real sectors, ~50 liquid
     NSE large/mid-caps across sectors. Fundamentals aren't available from a free live source,
     so scan52w.js generates clearly-labeled demo fundamentals per symbol; prices/52-week
     high-low/volume are fetched live with a deterministic demo fallback if a fetch fails. */
  scanUniverse: [
    { symbol: "RELIANCE.NS",   display: "RELIANCE",   name: "Reliance Industries",     sector: "Energy" },
    { symbol: "TCS.NS",        display: "TCS",         name: "Tata Consultancy Svcs",   sector: "IT" },
    { symbol: "HDFCBANK.NS",   display: "HDFCBANK",    name: "HDFC Bank",               sector: "Banking" },
    { symbol: "INFY.NS",       display: "INFY",        name: "Infosys",                 sector: "IT" },
    { symbol: "ICICIBANK.NS",  display: "ICICIBANK",   name: "ICICI Bank",              sector: "Banking" },
    { symbol: "ITC.NS",        display: "ITC",         name: "ITC Ltd",                 sector: "FMCG" },
    { symbol: "SBIN.NS",       display: "SBIN",        name: "State Bank of India",     sector: "Banking" },
    { symbol: "BHARTIARTL.NS", display: "BHARTIARTL",  name: "Bharti Airtel",           sector: "Telecom" },
    { symbol: "LT.NS",         display: "LT",          name: "Larsen & Toubro",         sector: "Infrastructure" },
    { symbol: "KOTAKBANK.NS",  display: "KOTAKBANK",   name: "Kotak Mahindra Bank",     sector: "Banking" },
    { symbol: "AXISBANK.NS",   display: "AXISBANK",    name: "Axis Bank",               sector: "Banking" },
    { symbol: "HINDUNILVR.NS", display: "HINDUNILVR",  name: "Hindustan Unilever",      sector: "FMCG" },
    { symbol: "BAJFINANCE.NS", display: "BAJFINANCE",  name: "Bajaj Finance",           sector: "Financial Svcs" },
    { symbol: "MARUTI.NS",     display: "MARUTI",      name: "Maruti Suzuki",           sector: "Auto" },
    { symbol: "SUNPHARMA.NS",  display: "SUNPHARMA",   name: "Sun Pharma",              sector: "Pharma" },
    { symbol: "TITAN.NS",      display: "TITAN",       name: "Titan Company",           sector: "Consumer" },
    { symbol: "ADANIENT.NS",   display: "ADANIENT",    name: "Adani Enterprises",       sector: "Metals/Infra" },
    { symbol: "ULTRACEMCO.NS", display: "ULTRACEMCO",  name: "UltraTech Cement",        sector: "Cement" },
    { symbol: "HCLTECH.NS",    display: "HCLTECH",     name: "HCL Technologies",        sector: "IT" },
    { symbol: "WIPRO.NS",      display: "WIPRO",       name: "Wipro",                   sector: "IT" },
    { symbol: "ASIANPAINT.NS", display: "ASIANPAINT",  name: "Asian Paints",            sector: "Consumer" },
    { symbol: "NESTLEIND.NS",  display: "NESTLEIND",   name: "Nestle India",            sector: "FMCG" },
    { symbol: "POWERGRID.NS",  display: "POWERGRID",   name: "Power Grid Corp",         sector: "Utilities" },
    { symbol: "NTPC.NS",       display: "NTPC",        name: "NTPC Ltd",                sector: "Utilities" },
    { symbol: "ONGC.NS",       display: "ONGC",        name: "Oil & Natural Gas Corp",  sector: "Energy" },
    { symbol: "COALINDIA.NS",  display: "COALINDIA",   name: "Coal India",              sector: "Metals/Infra" },
    { symbol: "TATASTEEL.NS",  display: "TATASTEEL",   name: "Tata Steel",              sector: "Metals/Infra" },
    { symbol: "JSWSTEEL.NS",   display: "JSWSTEEL",    name: "JSW Steel",               sector: "Metals/Infra" },
    { symbol: "HINDALCO.NS",   display: "HINDALCO",    name: "Hindalco Industries",     sector: "Metals/Infra" },
    { symbol: "GRASIM.NS",     display: "GRASIM",      name: "Grasim Industries",       sector: "Cement" },
    { symbol: "DRREDDY.NS",    display: "DRREDDY",     name: "Dr Reddy's Labs",         sector: "Pharma" },
    { symbol: "CIPLA.NS",      display: "CIPLA",       name: "Cipla",                   sector: "Pharma" },
    { symbol: "DIVISLAB.NS",   display: "DIVISLAB",    name: "Divi's Laboratories",     sector: "Pharma" },
    { symbol: "EICHERMOT.NS",  display: "EICHERMOT",   name: "Eicher Motors",           sector: "Auto" },
    { symbol: "HEROMOTOCO.NS", display: "HEROMOTOCO",  name: "Hero MotoCorp",           sector: "Auto" },
    { symbol: "TATAMOTORS.NS", display: "TATAMOTORS",  name: "Tata Motors",             sector: "Auto" },
    { symbol: "BAJAJFINSV.NS", display: "BAJAJFINSV",  name: "Bajaj Finserv",           sector: "Financial Svcs" },
    { symbol: "SBILIFE.NS",    display: "SBILIFE",     name: "SBI Life Insurance",      sector: "Financial Svcs" },
    { symbol: "HDFCLIFE.NS",   display: "HDFCLIFE",    name: "HDFC Life Insurance",     sector: "Financial Svcs" },
    { symbol: "PIDILITIND.NS", display: "PIDILITIND",  name: "Pidilite Industries",     sector: "Consumer" },
    { symbol: "DABUR.NS",      display: "DABUR",       name: "Dabur India",             sector: "FMCG" },
    { symbol: "BRITANNIA.NS",  display: "BRITANNIA",   name: "Britannia Industries",    sector: "FMCG" },
    { symbol: "SIEMENS.NS",    display: "SIEMENS",     name: "Siemens Ltd",             sector: "Infrastructure" },
    { symbol: "HAVELLS.NS",    display: "HAVELLS",     name: "Havells India",           sector: "Consumer" },
    { symbol: "DLF.NS",        display: "DLF",         name: "DLF Ltd",                 sector: "Real Estate" },
    { symbol: "INDUSINDBK.NS", display: "INDUSINDBK",  name: "IndusInd Bank",           sector: "Banking" },
    { symbol: "TECHM.NS",      display: "TECHM",       name: "Tech Mahindra",           sector: "IT" },
    { symbol: "APOLLOHOSP.NS", display: "APOLLOHOSP",  name: "Apollo Hospitals",        sector: "Healthcare" },
    { symbol: "ADANIPORTS.NS", display: "ADANIPORTS",  name: "Adani Ports",             sector: "Infrastructure" },
    { symbol: "TATACONSUM.NS", display: "TATACONSUM",  name: "Tata Consumer Products",  sector: "FMCG" }
  ],
